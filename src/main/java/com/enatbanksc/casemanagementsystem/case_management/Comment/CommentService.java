...
public interface CommentService {
    Comment commentOnLitigation(long litigationId, Comment comment, JwtAuthenticationToken token) throws IllegalAccessException;
    Comment commentOnJudiciaryReport(long judiciaryId, Comment comment, JwtAuthenticationToken token) throws IllegalAccessException;
