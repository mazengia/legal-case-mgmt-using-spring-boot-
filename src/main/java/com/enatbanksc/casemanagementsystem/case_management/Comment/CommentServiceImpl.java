...
public class CommentServiceImpl implements CommentService{
    ...
    @Override
    public Comment commentOnLitigation(long litigationId, Comment comment, JwtAuthenticationToken token) throws IllegalAccessException {
    ...
    @Override
    public Comment commentOnJudiciaryReport(long judiciaryId, Comment comment, JwtAuthenticationToken token) throws IllegalAccessException {
    ...
    public Comment updateComment(long id, Comment comment, JwtAuthenticationToken token) throws IllegalAccessException {
        var c = getComment(id);
        BeanUtils.copyProperties(comment, c, getNullPropertyNames(comment));
