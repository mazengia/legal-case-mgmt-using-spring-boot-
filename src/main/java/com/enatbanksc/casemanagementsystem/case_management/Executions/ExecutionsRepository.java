...
//    Page<Executions> findAllByLitigationTypeOrCourtAdjudicatingOrAttorneyHandlingTheCaseOrderByCreatedAtDesc(Pageable pageable, @Param("value") String value, @Param("status") String status);
    ...
    Page<Executions> findAllByDeletedIsFalseOrderByExecutionsIdDesc(Pageable pageable);
    Page<Executions> findExecutionsByAttorneyHandlingTheCaseAndDeletedIsFalseOrderByExecutionsIdDesc(Pageable pageable, String attorney);
